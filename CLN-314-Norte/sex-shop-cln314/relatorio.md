...
**Quadra:** CLN 314 Norte
**Categoria:** Sex Shop
**Endereço:** CLN 314 Bloco D Lj 61 - Subsolo - Asa Norte, Brasília - DF
**Telefone:** (61) 98152-1424
**Site:** *sem site*
**Google Maps:** [abrir](https://www.google.com/maps/place/?q=place_id:ChIJ...)
**Rating atual:** 4.5 (2 reviews)
...
|----------|-------|--------|
| Google Meu Negócio | 4/10 | 🟡 Melhorável |
| WhatsApp | 1/10 | 🔴 Crítico |
| Site | 0/10 | 🔴 Crítico |
| Instagram | — | ⚪ Verificação manual |
| **Total (GMB+WPP+Site)** | **5/30** | **🔴 ALTA PRIORIDADE** |

**Composição do score GMB:** Existência 2 + Volume 0 + Qualidade 1 + Completude 1 + Engajamento 0 = **4/10**

---

## Google Meu Negócio

GMB mínimo — nome genérico 'Sex Shop' em vez de marca. Apenas 2 reviews. Categoria de alta sensibilidade — demanda sigilo.
...
Número disponível. Categoria naturalmente WhatsApp-friendly (discrição).

## Site

Sem site. Mercado com demanda oculta — site com discrição seria valioso.
...
### 1. Gestão Google Meu Negócio — responder reviews
...
### 5. Auditoria de Instagram (verificação manual sugerida)
...
Landing page demo gerada em `landing-page/index.html` com nome, categoria, endereço, telefone e CTA de WhatsApp.

---

*Relatório gerado por /prospect — Singular Group*
*[Registrado por: DESKTOP — 2026-04-17]*
