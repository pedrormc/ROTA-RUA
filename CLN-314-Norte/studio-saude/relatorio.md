...
**Categoria:** Restaurante familiar (saudável?)
**Endereço:** SHCN SQN 314 - Asa Norte, Brasília - DF
**Telefone:** não cadastrado
**Site:** *sem site*
**Google Maps:** [abrir](https://www.google.com/maps/place/?q=place_id:ChIJ...)
**Rating atual:** 5.0 (5 reviews)
...
| WhatsApp | 0/10 | 🔴 Crítico |
| Site | 0/10 | 🔴 Crítico |
| Instagram | — | ⚪ Verificação manual |
| **Total (GMB+WPP+Site)** | **4/30** | **🔴 ALTA PRIORIDADE** |

**Composição do score GMB:** Existência 2 + Volume 0 + Qualidade 2 + Completude 0 + Engajamento 0 = **4/10**

---

## Google Meu Negócio

5.0 mas apenas 5 reviews, sem telefone cadastrado. GMB incompleto e com volume insuficiente pra relevância.
...
Sem WhatsApp. Sem telefone no GMB.

## Site

Sem site. Categorização do GMB como 'Restaurante familiar' é confusa — verificar do que se trata.
