# Dossie de Prosperccao — Estabelecimento 07 Norte

## 1. Identificacao
- **Nome Comercial:** Estabelecimento 07 Norte
- **Endereco:** CLN 312 Bloco A, Loja 25, Brasilia - DF
- **Nicho de Atuacao:** Cafeteria
- **Quadra Alvo:** CLN 312 Norte

## 2. Indicadores de Maturidade Digital & GMB
- **Qtd. de Avaliacoes (Google My Business):** 108 reviews
- **Possui Site Proprio:** Nao (Oportunidade Alta)
- **Score Ponderado de Oportunidade:** 127 / 100
...
- **Proximos Passos Comerciais:** 
  1. Abordagem presencial na CLN 312 Norte pelo time comercial (Simon).
