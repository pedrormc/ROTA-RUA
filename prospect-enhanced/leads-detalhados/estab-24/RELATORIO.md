# Dossie de Prosperccao — Estabelecimento 24 Norte

## 1. Identificacao
- **Nome Comercial:** Estabelecimento 24 Norte
- **Endereco:** CLN 310 Bloco A, Loja 16, Brasilia - DF
- **Nicho de Atuacao:** Restaurante
- **Quadra Alvo:** CLN 310 Norte

## 2. Indicadores de Maturidade Digital & GMB
- **Qtd. de Avaliacoes (Google My Business):** 61 reviews
- **Possui Site Proprio:** Nao (Oportunidade Alta)
- **Score Ponderado de Oportunidade:** 117 / 100
- **Classificacao no Funil:** P1 - Abordagem Direta
...
- **Proximos Passos Comerciais:** 
  1. Abordagem presencial na CLN 310 Norte pelo time comercial (Simon).
