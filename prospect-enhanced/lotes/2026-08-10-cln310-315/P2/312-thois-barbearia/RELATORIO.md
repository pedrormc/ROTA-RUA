...
| Campo | Valor |
|---|---|
| Nome | Thois Barbearia |
| Nicho (categoria Google) | Barbearia |
| Endereço | loja 45, Cln 312 norte, Brasília - DF, 70765-540 |
| Quadra (regex endereço) | CLN 312 |
| Quadra (conferência por CEP) | CLN 312 |
| Par de entrequadra | 312/313 |
| Telefone | (61) 3347-6724 |
| Site | http://www.instagram.com/thoisbarbearia |
| place_id | `ChIJGTAZ6iU6WpMR-EeoeAYWmhU` |
...
|---|---|---|
| Nota | 4.3 | Aceitável |
| Comentários | 60 | **P2** pela regra do lote (20–50 = P1 · >50 = P2 · <20 = P3) |
| Botão "Site" | presente | — |
...
1. `engine=google`, `q="Thois Barbearia" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
> Dei uma olhada no perfil de vocês no Google antes de entrar: 60 avaliações, nota 4.3.
