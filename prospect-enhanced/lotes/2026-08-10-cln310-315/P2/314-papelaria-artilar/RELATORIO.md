...
| Campo | Valor |
|---|---|
| Nome | Papelaria Artilar |
| Nicho (categoria Google) | Papelaria |
| Endereço | SHCN 314, Bloco E, Lojas 07/09 Térreo, SHCN, Brasília - DF, 70767-550 |
| Quadra (regex endereço) | CLN 314 |
| Quadra (conferência por CEP) | CLN 314 |
| Par de entrequadra | 314/315 |
| Telefone | (61) 99633-2850 |
| Site | http://www.papelariaartilar.com.br/ |
| place_id | `ChIJowW8wIk5WpMR0oDizOChJAY` |
...
|---|---|---|
| Nota | 4.2 | Aceitável |
| Comentários | 230 | **P2** pela regra do lote (20–50 = P1 · >50 = P2 · <20 = P3) |
| Botão "Site" | presente | — |
...
1. `engine=google`, `q="Papelaria Artilar" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
> Dei uma olhada no perfil de vocês no Google antes de entrar: 230 avaliações, nota 4.2.
