# Bijou Arte - acessórios e peças para montagem de bijouterias
...
| Campo | Valor |
|---|---|
| Nome | Bijou Arte - acessórios e peças para montagem de bijouterias |
| Nicho (categoria Google) | Loja de acessórios de moda |
| Endereço | Asa Norte CLN 311 Lj 18 - Asa Norte, Brasília - DF, 70757-520 |
| Quadra (regex endereço) | CLN 311 |
| Quadra (conferência por CEP) | CLN 311 |
| Par de entrequadra | 310/311 |
| Telefone | (61) 3347-3670 |
| Site | https://bijouarte.wixsite.com/bijouarte |
| place_id | `ChIJa9DLAjY6WpMRWqIdFfDFjQI` |
...
|---|---|---|
| Nota | 4.4 | Aceitável |
| Comentários | 140 | **P2** pela regra do lote (20–50 = P1 · >50 = P2 · <20 = P3) |
| Botão "Site" | presente | — |
...
1. `engine=google`, `q="Bijou Arte - acessórios e peças para montagem de bijouterias" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
> Dei uma olhada no perfil de vocês no Google antes de entrar: 140 avaliações, nota 4.4.
