# Atual Utilidades - Elétrica - Hidráulica - Ferragens - Asa Norte

**CLN 312 Norte** (par 312/313) · Prioridade **P2** · Lote `2026-08-10-cln310-315`
...
| Campo | Valor |
|---|---|
| Nome | Atual Utilidades - Elétrica - Hidráulica - Ferragens - Asa Norte |
| Nicho (categoria Google) | Loja de artigos domésticos |
| Endereço | Asa Norte Comércio Local Norte 312 Lj 02/64 - Asa Norte, Brasília - DF, 70765-510 |
| Quadra (regex endereço) | CLN 312 |
| Quadra (conferência por CEP) | CLN 312 |
| Par de entrequadra | 312/313 |
| Telefone | (61) 3340-3999 |
| Site | http://instagram.com/atualutilidades |
| place_id | `ChIJAeEs9iU6WpMRSkJqZwp2SvA` |
...
| Comentários | 80 | **P2** pela regra do lote (20–50 = P1 · >50 = P2 · <20 = P3) |
| Botão "Site" | presente | — |
...
1. `engine=google`, `q="Atual Utilidades - Elétrica - Hidráulica - Ferragens - Asa Norte" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
> Dei uma olhada no perfil de vocês no Google antes de entrar: 80 avaliações, nota 4.7.
