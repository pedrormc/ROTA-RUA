...
| Campo | Valor |
|---|---|
| Nome | Açaí Puríssimo - 310 Norte |
| Nicho (categoria Google) | Lanchonete |
| Endereço | CLN 310 - Bloco D - loja 01, SHCN, Brasília - DF, 70756-540 |
| Quadra (regex endereço) | CLN 310 |
| Quadra (conferência por CEP) | CLN 310 |
| Par de entrequadra | 310/311 |
| Telefone | (61) 98366-5768 |
| Site | http://www.acaipurissimo.com.br/ |
| place_id | `ChIJEVEjrq47WpMR9s11YunanRk` |
...
| Comentários | 515 | **P2** pela regra do lote (20–50 = P1 · >50 = P2 · <20 = P3) |
| Botão "Site" | presente | — |
...
1. `engine=google`, `q="Açaí Puríssimo - 310 Norte" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
> Dei uma olhada no perfil de vocês no Google antes de entrar: 515 avaliações, nota 4.6.
