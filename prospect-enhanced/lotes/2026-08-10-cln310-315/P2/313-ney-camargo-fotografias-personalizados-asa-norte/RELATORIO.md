# Ney Camargo Fotografias & Personalizados - Asa Norte
...
| Campo | Valor |
|---|---|
| Nome | Ney Camargo Fotografias & Personalizados - Asa Norte |
| Nicho (categoria Google) | Fotógrafo |
| Endereço | Asa Norte CLN 313, bloco D Lj 4 - Asa Norte, Brasília - DF, 70766-540 |
| Quadra (regex endereço) | CLN 313 |
| Quadra (conferência por CEP) | CLN 313 |
| Par de entrequadra | 312/313 |
| Telefone | (61) 99902-3966 |
| Site | — não publicado no perfil |
| place_id | `ChIJd3bqwiU6WpMRuDnOwAySVsM` |
...
|---|---|---|
| Nota | 4.4 | Aceitável |
| Comentários | 86 | **P2** pela regra do lote (20–50 = P1 · >50 = P2 · <20 = P3) |
...
1. `engine=google`, `q="Ney Camargo Fotografias & Personalizados - Asa Norte" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
|---|---|---|
| Sem site no perfil | **Criação de Landing Page** | Quando alguém pesquisa "fotógrafo Asa Norte", este negócio não tem para onde mandar o clique. |
...
> Dei uma olhada no perfil de vocês no Google antes de entrar: 86 avaliações, nota 4.4, e reparei que não tem site no perfil.
