...
| Campo | Valor |
|---|---|
| Nome | Constance - 313 Norte Brasília |
| Nicho (categoria Google) | Loja de calçado |
| Endereço | Quadra, CLN 313 - Asa Norte, Brasília - DF, 70766-550 |
| Quadra (regex endereço) | CLN 313 |
| Quadra (conferência por CEP) | CLN 313 |
| Par de entrequadra | 312/313 |
| Telefone | (61) 3546-4114 |
| Site | http://www.constance.com.br/ |
| place_id | `ChIJbfLkoDY6WpMRhueiGHUSLrc` |
...
1. `engine=google`, `q="Constance - 313 Norte Brasília" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
> Dei uma olhada no perfil de vocês no Google antes de entrar: 144 avaliações, nota 4.6.
