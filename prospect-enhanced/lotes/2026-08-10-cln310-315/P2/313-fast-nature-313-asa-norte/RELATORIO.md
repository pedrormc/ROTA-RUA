...
| Campo | Valor |
|---|---|
| Nome | Fast Nature - 313 Asa norte |
| Nicho (categoria Google) | Lanchonete |
| Endereço | SHCN CLN 313 Lj 10 - Plano Piloto, Brasília - DF, 70766-550 |
| Quadra (regex endereço) | CLN 313 |
| Quadra (conferência por CEP) | CLN 313 |
| Par de entrequadra | 312/313 |
| Telefone | (61) 99875-4591 |
| Site | https://www.instagram.com/fast_nature?igsh=d2M0ank5aGQxcHl5 |
| place_id | `ChIJzbSRxCU6WpMRmMKbc_4b_lY` |
...
|---|---|---|
| Nota | 4.3 | Aceitável |
| Comentários | 916 | **P2** pela regra do lote (20–50 = P1 · >50 = P2 · <20 = P3) |
| Botão "Site" | presente | — |
...
1. `engine=google`, `q="Fast Nature - 313 Asa norte" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
> Dei uma olhada no perfil de vocês no Google antes de entrar: 916 avaliações, nota 4.3.
