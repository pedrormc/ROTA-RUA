# Lavamais Lavanderia - Asa Norte - 311 Norte
...
| Campo | Valor |
|---|---|
| Nome | Lavamais Lavanderia - Asa Norte - 311 Norte |
| Nicho (categoria Google) | Lavanderia |
| Endereço | Asa Norte Comércio Local Norte 311 Lj 02 - Asa Norte, Brasília - DF, 70757-530 |
| Quadra (regex endereço) | CLN 311 |
| Quadra (conferência por CEP) | CLN 311 |
| Par de entrequadra | 310/311 |
| Telefone | (61) 3033-3295 |
| Site | — não publicado no perfil |
| place_id | `ChIJVVVFijA6WpMRM46W5FLU4xI` |
...
1. `engine=google`, `q="Lavamais Lavanderia - Asa Norte - 311 Norte" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
> Dei uma olhada no perfil de vocês no Google antes de entrar: 55 avaliações, nota 4.6, e reparei que não tem site no perfil.
