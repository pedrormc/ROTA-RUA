...
| Campo | Valor |
|---|---|
| Nome | Restaurante Dom De Minas |
| Nicho (categoria Google) | Restaurante self-service |
| Endereço | Asa Norte CLN 311, BL B Lj 62 - Asa Norte, Brasília - DF, 70713-000 |
| Quadra (regex endereço) | CLN 311 |
| Quadra (conferência por CEP) | CEP fora da tabela canônica |
| Par de entrequadra | 310/311 |
| Telefone | (61) 99890-7574 |
| Site | — não publicado no perfil |
| place_id | `ChIJ4TK89DA6WpMRGRrYPx0afCs` |
...
|---|---|---|
| Nota | 4 | Aceitável |
| Comentários | 99 | **P2** pela regra do lote (20–50 = P1 · >50 = P2 · <20 = P3) |
...
1. `engine=google`, `q="Restaurante Dom De Minas" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
|---|---|---|
| Sem site no perfil | **Criação de Landing Page** | Quando alguém pesquisa "restaurante self-service Asa Norte", este negócio não tem para onde mandar o clique. |
...
> Dei uma olhada no perfil de vocês no Google antes de entrar: 99 avaliações, nota 4, e reparei que não tem site no perfil.
