...
| Endereço | Asa Norte CLN 312, BL A Lj 8 - Plano Piloto, Brasília - DF, 70765-510 |
| Quadra (regex endereço) | CLN 312 |
| Quadra (conferência por CEP) | CLN 312 |
| Par de entrequadra | 312/313 |
| Telefone | (61) 99817-4651 |
| Site | https://floriculturaverdivas.com.br/ |
| place_id | `ChIJqYKuXb87WpMRc_Npk1EXsoU` |
...
| Comentários | 94 | **P2** pela regra do lote (20–50 = P1 · >50 = P2 · <20 = P3) |
| Botão "Site" | presente | — |
...
1. `engine=google`, `q="Verdivas" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
> Dei uma olhada no perfil de vocês no Google antes de entrar: 94 avaliações, nota 4.8.
