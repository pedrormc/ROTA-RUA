...
| Campo | Valor |
|---|---|
| Nome | Senhora BaforadaTabacaria |
| Nicho (categoria Google) | Tabacaria |
| Endereço | Asa Norte CLN 310 Lj 74 - Asa Norte, Brasília - DF, 70756-530 |
| Quadra (regex endereço) | CLN 310 |
| Quadra (conferência por CEP) | CLN 310 |
| Par de entrequadra | 310/311 |
| Telefone | (61) 3034-5420 |
| Site | http://www.senhorabaforada.com.br/ |
| place_id | `ChIJowNnO2s7WpMRmanA-DiEfYQ` |
...
| Comentários | 507 | **P2** pela regra do lote (20–50 = P1 · >50 = P2 · <20 = P3) |
| Botão "Site" | presente | — |
...
1. `engine=google`, `q="Senhora BaforadaTabacaria" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
> Dei uma olhada no perfil de vocês no Google antes de entrar: 507 avaliações, nota 4.9.
