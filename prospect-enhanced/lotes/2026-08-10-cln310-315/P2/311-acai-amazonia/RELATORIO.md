...
|---|---|
| Nome | Açaí Amazônia |
| Nicho (categoria Google) | Loja |
| Endereço | SHCN CLN 311 - Asa Norte, Brasília - DF, 70757-520 |
| Quadra (regex endereço) | CLN 311 |
| Quadra (conferência por CEP) | CLN 311 |
| Par de entrequadra | 310/311 |
| Telefone | (61) 99966-7089 |
| Site | http://acaiamazonia.com/novo/?page_id=4022 |
| place_id | `ChIJn96wWDA6WpMRwwcit8qrr3Q` |
...
|---|---|---|
| Nota | 4.3 | Aceitável |
| Comentários | 429 | **P2** pela regra do lote (20–50 = P1 · >50 = P2 · <20 = P3) |
| Botão "Site" | presente | — |
...
1. `engine=google`, `q="Açaí Amazônia" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
> Dei uma olhada no perfil de vocês no Google antes de entrar: 429 avaliações, nota 4.3.
