...
| Campo | Valor |
|---|---|
| Nome | Lavanderia Alv Clean |
| Nicho (categoria Google) | Lavanderia |
| Endereço | Asa Norte CLN 312 Lj 12 - Asa Norte, Brasília - DF, 70765-510 |
| Quadra (regex endereço) | CLN 312 |
| Quadra (conferência por CEP) | CLN 312 |
| Par de entrequadra | 312/313 |
| Telefone | (61) 3032-3113 |
| Site | https://sites.google.com/view/alvclean/p%C3%A1gina-inicial |
| place_id | `ChIJOfpV9iU6WpMRQqGUOgZ48DA` |
...
| Comentários | 58 | **P2** pela regra do lote (20–50 = P1 · >50 = P2 · <20 = P3) |
| Botão "Site" | presente | — |
...
1. `engine=google`, `q="Lavanderia Alv Clean" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
> Dei uma olhada no perfil de vocês no Google antes de entrar: 58 avaliações, nota 4.8.
