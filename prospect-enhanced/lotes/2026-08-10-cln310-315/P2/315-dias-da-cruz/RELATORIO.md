...
|---|---|
| Nome | Dias da Cruz |
| Nicho (categoria Google) | Farmácia de homeopatia |
| Endereço | SHCN CLN 315 Lojas 16/20 - Asa Norte, Brasília - DF, 70774-540 |
| Quadra (regex endereço) | CLN 315 |
| Quadra (conferência por CEP) | CLN 315 |
| Par de entrequadra | 314/315 |
| Telefone | (61) 3030-6262 |
| Site | https://www.diasdacruz.com.br/ |
| place_id | `ChIJAQDQu4k5WpMR5DAGDgVHPBU` |
...
|---|---|---|
| Nota | 4.3 | Aceitável |
| Comentários | 153 | **P2** pela regra do lote (20–50 = P1 · >50 = P2 · <20 = P3) |
| Botão "Site" | presente | — |
...
1. `engine=google`, `q="Dias da Cruz" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
> Dei uma olhada no perfil de vocês no Google antes de entrar: 153 avaliações, nota 4.3.
