...
|---|---|
| Nome | Cristal Fit |
| Nicho (categoria Google) | Academia |
| Endereço | Asa Norte Comércio Local Norte 311 Bl E - Asa Norte, Brasília - DF, 70757-550 |
| Quadra (regex endereço) | CLN 311 |
| Quadra (conferência por CEP) | CLN 311 |
| Par de entrequadra | 310/311 |
| Telefone | (61) 99247-1175 |
| Site | https://www.academiacristalfit.com.br/ |
| place_id | `ChIJS_pFgTA6WpMRbFj8G2-ejj8` |
...
| Comentários | 256 | **P2** pela regra do lote (20–50 = P1 · >50 = P2 · <20 = P3) |
| Botão "Site" | presente | — |
...
1. `engine=google`, `q="Cristal Fit" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
> Dei uma olhada no perfil de vocês no Google antes de entrar: 256 avaliações, nota 4.6.
