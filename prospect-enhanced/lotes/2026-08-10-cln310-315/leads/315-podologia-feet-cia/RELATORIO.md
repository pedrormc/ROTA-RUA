...
| Campo | Valor |
|---|---|
| Nome | Podologia Feet & Cia |
| Nicho (categoria Google) | Podólogo |
| Endereço | Asa Norte CLN 315, BL C Lj 48 - Subsolo - Asa Norte, Brasília - DF, 70774-530 |
| Quadra (regex endereço) | CLN 315 |
| Quadra (conferência por CEP) | CLN 315 |
| Par de entrequadra | 314/315 |
| Telefone | (61) 98420-0601 |
| Site | https://juanmoura.wixsite.com/podologiafeetecia |
| place_id | `ChIJCzXfVo85WpMRHxAGD-GJ8n4` |
...
1. `engine=google`, `q="Podologia Feet & Cia" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
> Dei uma olhada no perfil de vocês no Google antes de entrar: 21 avaliações, nota 5.
