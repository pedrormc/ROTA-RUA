...
| Endereço | BL B, Comércio Local Norte, 311 - Loja 14 - Asa Norte, Brasília - DF, 70757-520 |
| Quadra (regex endereço) | CLN 311 |
| Quadra (conferência por CEP) | CLN 311 |
| Par de entrequadra | 310/311 |
| Telefone | (61) 3256-7129 |
| Site | http://www.lojasviaflora.com.br/ |
| place_id | `ChIJBaSPtlMuWpMRkYg5c5nADpY` |
...
| Comentários | 37 | **P1** pela regra do lote (20–50 = P1 · >50 = P2 · <20 = P3) |
| Botão "Site" | presente | — |
...
1. `engine=google`, `q="VIA FLORA" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
> Dei uma olhada no perfil de vocês no Google antes de entrar: 37 avaliações, nota 4.7.
