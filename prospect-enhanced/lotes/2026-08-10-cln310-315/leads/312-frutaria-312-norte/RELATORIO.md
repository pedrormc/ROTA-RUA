...
| Campo | Valor |
|---|---|
| Nome | Frutaria 312 Norte |
| Nicho (categoria Google) | Mercado |
| Endereço | SHCN CLN 312, BL D - Plano Piloto, Brasília - DF, 70765-500 |
| Quadra (regex endereço) | CLN 312 |
| Quadra (conferência por CEP) | CLN 312 |
| Par de entrequadra | 312/313 |
| Telefone | (61) 3710-3333 |
| Site | — não publicado no perfil |
| place_id | `ChIJC38tHCk7WpMRligpYW7ipiA` |
...
|---|---|---|
| Nota | 4.3 | Aceitável |
| Comentários | 30 | **P1** pela regra do lote (20–50 = P1 · >50 = P2 · <20 = P3) |
...
1. `engine=google`, `q="Frutaria 312 Norte" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
|---|---|---|
| Sem site no perfil | **Criação de Landing Page** | Quando alguém pesquisa "mercado Asa Norte", este negócio não tem para onde mandar o clique. |
...
> Dei uma olhada no perfil de vocês no Google antes de entrar: 30 avaliações, nota 4.3, e reparei que não tem site no perfil.
