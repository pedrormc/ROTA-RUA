...
| Campo | Valor |
|---|---|
| Nome | Lavou Lavanderia Self Service |
| Nicho (categoria Google) | Lavanderia |
| Endereço | Asa Norte CLN 310 Lj 17 - Asa Norte, Brasília - DF, 70756-540 |
| Quadra (regex endereço) | CLN 310 |
| Quadra (conferência por CEP) | CLN 310 |
| Par de entrequadra | 310/311 |
| Telefone | (61) 99456-8787 |
| Site | https://lavoulavanderia.com.br/ |
| place_id | `ChIJrQwP6HM7WpMReYugV1kbFxI` |
...
1. `engine=google`, `q="Lavou Lavanderia Self Service" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
> Dei uma olhada no perfil de vocês no Google antes de entrar: 94 avaliações, nota 4.
