# DL Assistência Técnica - Conserto de Fogão,Microondas, Forno, TV, Geladeira, Lava e seca, Adega
...
| Campo | Valor |
|---|---|
| Nome | DL Assistência Técnica - Conserto de Fogão,Microondas, Forno, TV, Geladeira, Lava e seca, Adega |
| Nicho (categoria Google) | Assistência técnica de eletrodomésticos |
| Endereço | SHCN CLN 311 Bloco D , loja 36 - Plano Piloto, Brasília - DF, 70757-540 |
| Quadra (regex endereço) | CLN 311 |
| Quadra (conferência por CEP) | CLN 311 |
| Par de entrequadra | 310/311 |
| Telefone | (61) 99977-0889 |
| Site | — não publicado no perfil |
| place_id | `ChIJ2WUoIwA7WpMRdoRfbVW7RHQ` |
...
| Comentários | 148 | **P2** pela regra do lote (20–50 = P1 · >50 = P2 · <20 = P3) |
...
1. `engine=google`, `q="DL Assistência Técnica - Conserto de Fogão,Microondas, Forno, TV, Geladeira, Lava e seca, Adega" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
|---|---|---|
| Sem site no perfil | **Criação de Landing Page** | Quando alguém pesquisa "assistência técnica de eletrodomésticos Asa Norte", este negócio não tem para onde mandar o clique. |
...
> Dei uma olhada no perfil de vocês no Google antes de entrar: 148 avaliações, nota 4.7, e reparei que não tem site no perfil.
