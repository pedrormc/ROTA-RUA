...
| Campo | Valor |
|---|---|
| Nome | Mercado Malunga |
| Nicho (categoria Google) | Loja de produtos orgânicos |
| Endereço | Asa Norte Comércio Local Norte 315 loja 04 - Asa Norte, Brasília - DF, 70774-550 |
| Quadra (regex endereço) | CLN 315 |
| Quadra (conferência por CEP) | CLN 315 |
| Par de entrequadra | 314/315 |
| Telefone | (61) 99258-4089 |
| Site | https://mercadomalunga.com.br/ |
| place_id | `ChIJEWI0KYk5WpMR-EmK1PpUquM` |
...
1. `engine=google`, `q="Mercado Malunga" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
> Dei uma olhada no perfil de vocês no Google antes de entrar: 515 avaliações, nota 4.4.
