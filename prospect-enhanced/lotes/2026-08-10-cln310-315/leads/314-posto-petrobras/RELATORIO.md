...
| Nicho (categoria Google) | Posto de combustível |
| Endereço | Asa Norte Superquadra Norte 314 - Asa Norte, Brasília - DF, 70767-500 |
...
| Site | https://www.postospetrobras.com.br/?utm_source=gmb&utm_medium=search |
| place_id | `ChIJLagUQLU7WpMRWls6pkC80zM` |
...
| Comentários | 563 | **P2** pela regra do lote (20–50 = P1 · >50 = P2 · <20 = P3) |
| Botão "Site" | presente | — |
...
1. `engine=google`, `q="Posto Petrobras" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
> **Conferir manualmente:** Posto de combustível - revendedor costuma ser dono local
...
> Dei uma olhada no perfil de vocês no Google antes de entrar: 563 avaliações, nota 3.9.
