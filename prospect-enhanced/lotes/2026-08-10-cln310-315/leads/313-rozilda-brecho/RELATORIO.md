...
| Endereço | Asa Norte Comércio Local Norte 313 Bl A Lj 47 - Plano Piloto, Brasília - DF, 70766-510 |
| Quadra (regex endereço) | CLN 313 |
| Quadra (conferência por CEP) | CLN 313 |
| Par de entrequadra | 312/313 |
| Telefone | (61) 99402-5926 |
| Site | — não publicado no perfil |
| place_id | `ChIJG1Y9-iU6WpMRwnqfRKwVYqU` |

## Google Meu Negócio

| Sinal | Valor | Leitura |
|---|---|---|
| Nota | 3.7 | Reputação fraca — argumento de entrada |
| Comentários | 11 | **P3** pela regra do lote (20–50 = P1 · >50 = P2 · <20 = P3) |
...
1. `engine=google`, `q="Rozilda Brechó" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
|---|---|---|
| Sem site no perfil | **Criação de Landing Page** | Quando alguém pesquisa "loja de roupa Asa Norte", este negócio não tem para onde mandar o clique. |
...
| Só 11 comentários | **Gestão Google Meu Negócio** | Volume baixo de avaliação derruba o rank local. Campanha de avaliação resolve em 60 dias. |
...
> Dei uma olhada no perfil de vocês no Google antes de entrar: 11 avaliações, nota 3.7, e reparei que não tem site no perfil.
