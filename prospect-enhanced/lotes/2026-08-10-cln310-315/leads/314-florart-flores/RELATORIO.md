...
|---|---|
| Nome | Florart Flores |
| Nicho (categoria Google) | Floricultura |
| Endereço | Asa Norte CLN 314, Norte Bloco E - Asa Norte, Brasília - DF, 70767-550 |
| Quadra (regex endereço) | CLN 314 |
| Quadra (conferência por CEP) | CLN 314 |
| Par de entrequadra | 314/315 |
| Telefone | (61) 99824-6242 |
| Site | — não publicado no perfil |
| place_id | `ChIJ9-1dlYk5WpMRtx_uMj1q2FI` |
...
|---|---|---|
| Nota | 4.2 | Aceitável |
| Comentários | 281 | **P2** pela regra do lote (20–50 = P1 · >50 = P2 · <20 = P3) |
...
1. `engine=google`, `q="Florart Flores" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
|---|---|---|
| Sem site no perfil | **Criação de Landing Page** | Quando alguém pesquisa "floricultura Asa Norte", este negócio não tem para onde mandar o clique. |
...
> Dei uma olhada no perfil de vocês no Google antes de entrar: 281 avaliações, nota 4.2, e reparei que não tem site no perfil.
