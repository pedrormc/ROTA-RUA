# Refrigeração Querobino

**CLN 310 Norte** (par 310/311) · Prioridade **P1** · Lote `2026-08-10-cln310-315`
...
|---|---|---|
| Nota | 4.2 | Aceitável |
| Comentários | 39 | **P1** pela regra do lote (20–50 = P1 · >50 = P2 · <20 = P3) |
...
1. `engine=google`, `q="Refrigeração Querobino" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
> Dei uma olhada no perfil de vocês no Google antes de entrar: 39 avaliações, nota 4.2, e reparei que não tem site no perfil.
