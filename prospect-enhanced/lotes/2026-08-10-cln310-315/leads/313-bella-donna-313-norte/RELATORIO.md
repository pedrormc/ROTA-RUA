...
| Campo | Valor |
|---|---|
| Nome | BELLA DONNA 313 NORTE |
| Nicho (categoria Google) | Salão de Beleza |
| Endereço | Asa Norte Comércio Local Norte 313 - Asa Norte, Brasília - DF, 70766-550 |
| Quadra (regex endereço) | CLN 313 |
| Quadra (conferência por CEP) | CLN 313 |
| Par de entrequadra | 312/313 |
| Telefone | (61) 3340-4456 |
| Site | — não publicado no perfil |
| place_id | `ChIJ__8v2yU6WpMR89VSBJ2cRSE` |
...
|---|---|---|
| Nota | 4.1 | Aceitável |
| Comentários | 23 | **P1** pela regra do lote (20–50 = P1 · >50 = P2 · <20 = P3) |
...
1. `engine=google`, `q="BELLA DONNA 313 NORTE" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
> Dei uma olhada no perfil de vocês no Google antes de entrar: 23 avaliações, nota 4.1, e reparei que não tem site no perfil.
