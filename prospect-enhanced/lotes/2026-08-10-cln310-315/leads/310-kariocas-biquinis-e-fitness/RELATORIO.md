...
| Campo | Valor |
|---|---|
| Nome | Kariocas Biquínis e Fitness |
| Nicho (categoria Google) | Loja de moda feminina |
| Endereço | Asa Norte QD 310, BLOCO B Lj 01 TÉRREO - Asa Norte, Brasília - DF, 70756-520 |
| Quadra (regex endereço) | CLN 310 |
| Quadra (conferência por CEP) | CLN 310 |
| Par de entrequadra | 310/311 |
| Telefone | (61) 99981-3936 |
| Site | https://kariocas.com.br/ |
| place_id | `ChIJ__TFnKszWpMRn0Lk2Q6fGoM` |
...
| Comentários | 557 | **P2** pela regra do lote (20–50 = P1 · >50 = P2 · <20 = P3) |
| Botão "Site" | presente | — |
...
1. `engine=google`, `q="Kariocas Biquínis e Fitness" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
> Dei uma olhada no perfil de vocês no Google antes de entrar: 557 avaliações, nota 5.
