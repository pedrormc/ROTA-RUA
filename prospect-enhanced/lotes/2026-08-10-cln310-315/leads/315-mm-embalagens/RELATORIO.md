...
|---|---|
| Nome | MM Embalagens |
| Nicho (categoria Google) | Empresa de embalagens |
| Endereço | Asa Norte CLN 315 Lj 04/68 - Asa Norte, Brasília - DF, 70774-500 |
| Quadra (regex endereço) | CLN 315 |
| Quadra (conferência por CEP) | CLN 315 |
| Par de entrequadra | 314/315 |
| Telefone | (61) 3349-8885 |
| Site | http://mmembalagensltda.com.br/ |
| place_id | `ChIJ_SLwuIk5WpMRt5IBvVEJIOM` |
...
|---|---|---|
| Nota | 4.3 | Aceitável |
| Comentários | 225 | **P2** pela regra do lote (20–50 = P1 · >50 = P2 · <20 = P3) |
| Botão "Site" | presente | — |
...
1. `engine=google`, `q="MM Embalagens" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
> Dei uma olhada no perfil de vocês no Google antes de entrar: 225 avaliações, nota 4.3.
