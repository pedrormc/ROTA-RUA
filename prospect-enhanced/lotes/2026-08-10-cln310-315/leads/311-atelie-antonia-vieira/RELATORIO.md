# Ateliê Antônia Vieira

**CLN 311 Norte** (par 310/311) · Prioridade **P3** · Lote `2026-08-10-cln310-315`
...
| Campo | Valor |
|---|---|
| Nome | Ateliê Antônia Vieira |
| Nicho (categoria Google) | Costureira |
| Endereço | CLN 311 Bloco B Subsolo Loja 37, Asa Norte, Brasília - DF, 70360-530 |
| Quadra (regex endereço) | CLN 311 |
| Quadra (conferência por CEP) | CEP fora da tabela canônica |
| Par de entrequadra | 310/311 |
| Telefone | (61) 99524-9428 |
| Site | — não publicado no perfil |
| place_id | `ChIJX-ZENHc7WpMRq-vVjek_FLA` |
...
| Comentários | 17 | **P3** pela regra do lote (20–50 = P1 · >50 = P2 · <20 = P3) |
...
1. `engine=google`, `q="Ateliê Antônia Vieira" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
|---|---|---|
| Sem site no perfil | **Criação de Landing Page** | Quando alguém pesquisa "costureira Asa Norte", este negócio não tem para onde mandar o clique. |
...
| Só 17 comentários | **Gestão Google Meu Negócio** | Volume baixo de avaliação derruba o rank local. Campanha de avaliação resolve em 60 dias. |
...
> Dei uma olhada no perfil de vocês no Google antes de entrar: 17 avaliações, nota 4.5, e reparei que não tem site no perfil.
