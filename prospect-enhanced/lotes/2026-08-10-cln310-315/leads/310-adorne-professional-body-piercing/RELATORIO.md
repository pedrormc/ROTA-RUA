# Adorne Professional Body Piercing
...
| Campo | Valor |
|---|---|
| Nome | Adorne Professional Body Piercing |
| Nicho (categoria Google) | Loja de body piercing |
| Endereço | Asa Norte CLN 310, BL E Sala 214 - Plano Piloto, Brasília - DF, 70756-550 |
| Quadra (regex endereço) | CLN 310 |
| Quadra (conferência por CEP) | CLN 310 |
| Par de entrequadra | 310/311 |
| Telefone | (61) 98407-7878 |
| Site | — não publicado no perfil |
| place_id | `ChIJRdSltxw7WpMR7FYuZbU5yMU` |
...
| Comentários | 634 | **P2** pela regra do lote (20–50 = P1 · >50 = P2 · <20 = P3) |
...
1. `engine=google`, `q="Adorne Professional Body Piercing" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
|---|---|---|
| Sem site no perfil | **Criação de Landing Page** | Quando alguém pesquisa "loja de body piercing Asa Norte", este negócio não tem para onde mandar o clique. |
...
> Dei uma olhada no perfil de vocês no Google antes de entrar: 634 avaliações, nota 4.9, e reparei que não tem site no perfil.
