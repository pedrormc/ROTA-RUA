...
|---|---|
| Nome | Gaiatos Kids |
| Nicho (categoria Google) | Loja de moda infantil |
| Endereço | Loja 20, CLN 315 Lj 20 - Asa Norte, Brasília - DF, 70774-550 |
| Quadra (regex endereço) | CLN 315 |
| Quadra (conferência por CEP) | CLN 315 |
| Par de entrequadra | 314/315 |
| Telefone | (61) 99851-5702 |
| Site | https://www.gaiatoskids.com.br/ |
| place_id | `ChIJ9VJB3m85WpMRSSCXALjjp_A` |
...
1. `engine=google`, `q="Gaiatos Kids" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
> Dei uma olhada no perfil de vocês no Google antes de entrar: 11 avaliações, nota 5.
