# Alfaitaria por Eduardo Ferreira
...
| Campo | Valor |
|---|---|
| Nome | Alfaitaria por Eduardo Ferreira |
| Nicho (categoria Google) | Alfaiate |
| Endereço | Asa Norte CLN 311, BL B ss 04 - Asa Norte, Brasília - DF, 70757-520 |
| Quadra (regex endereço) | CLN 311 |
| Quadra (conferência por CEP) | CLN 311 |
| Par de entrequadra | 310/311 |
| Telefone | (61) 98107-1994 |
| Site | — não publicado no perfil |
| place_id | `ChIJ6_OkpMM7WpMRuy0lzwcgKvs` |
...
| Comentários | 144 | **P2** pela regra do lote (20–50 = P1 · >50 = P2 · <20 = P3) |
...
1. `engine=google`, `q="Alfaitaria por Eduardo Ferreira" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
|---|---|---|
| Sem site no perfil | **Criação de Landing Page** | Quando alguém pesquisa "alfaiate Asa Norte", este negócio não tem para onde mandar o clique. |
...
> Dei uma olhada no perfil de vocês no Google antes de entrar: 144 avaliações, nota 4.9, e reparei que não tem site no perfil.
