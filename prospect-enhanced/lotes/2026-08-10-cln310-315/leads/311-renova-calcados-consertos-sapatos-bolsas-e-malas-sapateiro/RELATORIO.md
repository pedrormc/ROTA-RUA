# Renova Calçados Consertos Sapatos, Bolsas e Malas - Sapateiro
...
| Campo | Valor |
|---|---|
| Nome | Renova Calçados Consertos Sapatos, Bolsas e Malas - Sapateiro |
| Nicho (categoria Google) | Oficina de conserto de botas |
| Endereço | Asa Norte Comércio Local Norte 311 - Plano Piloto, Brasília - DF, 70757-530 |
| Quadra (regex endereço) | CLN 311 |
| Quadra (conferência por CEP) | CLN 311 |
| Par de entrequadra | 310/311 |
| Telefone | (61) 98200-6985 |
| Site | — não publicado no perfil |
| place_id | `ChIJkzZnB-Y6WpMRCHs-uVCuVXA` |
...
| Comentários | 105 | **P2** pela regra do lote (20–50 = P1 · >50 = P2 · <20 = P3) |
...
1. `engine=google`, `q="Renova Calçados Consertos Sapatos, Bolsas e Malas - Sapateiro" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
|---|---|---|
| Sem site no perfil | **Criação de Landing Page** | Quando alguém pesquisa "oficina de conserto de botas Asa Norte", este negócio não tem para onde mandar o clique. |
...
> Dei uma olhada no perfil de vocês no Google antes de entrar: 105 avaliações, nota 3.9, e reparei que não tem site no perfil.
