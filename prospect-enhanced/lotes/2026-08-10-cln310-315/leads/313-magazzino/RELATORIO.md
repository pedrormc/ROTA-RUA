...
|---|---|
| Nome | Magazzino |
| Nicho (categoria Google) | Loja de acessórios de moda |
| Endereço | Asa Norte CLN 313, BL D Lj 54 - Asa Norte, Brasília - DF, 70766-540 |
| Quadra (regex endereço) | CLN 313 |
| Quadra (conferência por CEP) | CLN 313 |
| Par de entrequadra | 312/313 |
| Telefone | (61) 98110-2891 |
| Site | — não publicado no perfil |
| place_id | `ChIJkQG-3SU6WpMRbiovzShehkA` |
...
| Comentários | 13 | **P3** pela regra do lote (20–50 = P1 · >50 = P2 · <20 = P3) |
...
1. `engine=google`, `q="Magazzino" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
|---|---|---|
| Sem site no perfil | **Criação de Landing Page** | Quando alguém pesquisa "loja de acessórios de moda Asa Norte", este negócio não tem para onde mandar o clique. |
...
| Só 13 comentários | **Gestão Google Meu Negócio** | Volume baixo de avaliação derruba o rank local. Campanha de avaliação resolve em 60 dias. |
...
> Dei uma olhada no perfil de vocês no Google antes de entrar: 13 avaliações, nota 4.7, e reparei que não tem site no perfil.
