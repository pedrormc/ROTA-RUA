# Cão Mais Gato - Boutique Pet e Veterinária
...
| Campo | Valor |
|---|---|
| Nome | Cão Mais Gato - Boutique Pet e Veterinária |
| Nicho (categoria Google) | Veterinário |
| Endereço | Asa Norte CLN 310, bloco D Lj 05 - Asa Norte, Brasília - DF, 70756-540 |
| Quadra (regex endereço) | CLN 310 |
| Quadra (conferência por CEP) | CLN 310 |
| Par de entrequadra | 310/311 |
| Telefone | (61) 99607-3200 |
| Site | https://caomaisgato.com.br/ |
| place_id | `ChIJi0rmJkk7WpMRpmdsI--pym0` |
...
| Comentários | 182 | **P2** pela regra do lote (20–50 = P1 · >50 = P2 · <20 = P3) |
| Botão "Site" | presente | — |
...
1. `engine=google`, `q="Cão Mais Gato - Boutique Pet e Veterinária" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
> Dei uma olhada no perfil de vocês no Google antes de entrar: 182 avaliações, nota 4.8.
