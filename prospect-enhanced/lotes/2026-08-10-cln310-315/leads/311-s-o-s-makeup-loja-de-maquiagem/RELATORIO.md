# S.O.S Makeup - Loja de Maquiagem

**CLN 311 Norte** (par 310/311) · Prioridade **P1** · Lote `2026-08-10-cln310-315`
...
| Campo | Valor |
|---|---|
| Nome | S.O.S Makeup - Loja de Maquiagem |
| Nicho (categoria Google) | Loja de produtos de beleza |
| Endereço | Asa Norte CLN 311 Lj 18 - Asa Norte, Brasília - DF, 70757-530 |
| Quadra (regex endereço) | CLN 311 |
| Quadra (conferência por CEP) | CLN 311 |
| Par de entrequadra | 310/311 |
| Telefone | (61) 98202-9506 |
| Site | — não publicado no perfil |
| place_id | `ChIJ3_MgRXU7WpMRY-TOXMYCzp4` |
...
| Comentários | 26 | **P1** pela regra do lote (20–50 = P1 · >50 = P2 · <20 = P3) |
...
1. `engine=google`, `q="S.O.S Makeup - Loja de Maquiagem" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
|---|---|---|
| Sem site no perfil | **Criação de Landing Page** | Quando alguém pesquisa "loja de produtos de beleza Asa Norte", este negócio não tem para onde mandar o clique. |
...
> Dei uma olhada no perfil de vocês no Google antes de entrar: 26 avaliações, nota 4.5, e reparei que não tem site no perfil.
