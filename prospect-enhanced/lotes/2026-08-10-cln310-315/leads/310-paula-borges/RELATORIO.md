...
| Endereço | Asa Norte Comércio Local Norte 310, loja 35 - Asa Norte, Brasília - DF, 70756-540 |
| Quadra (regex endereço) | CLN 310 |
| Quadra (conferência por CEP) | CLN 310 |
| Par de entrequadra | 310/311 |
| Telefone | (61) 3447-3685 |
| Site | — não publicado no perfil |
| place_id | `ChIJ_0JVkDA6WpMRvAAGTqH1HDQ` |
...
1. `engine=google`, `q="PAULA BORGES" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
> Dei uma olhada no perfil de vocês no Google antes de entrar: 17 avaliações, nota 4.8, e reparei que não tem site no perfil.
