# MaxForm Suplementos Alimentares 315 Asa Norte
...
| Campo | Valor |
|---|---|
| Nome | MaxForm Suplementos Alimentares 315 Asa Norte |
| Nicho (categoria Google) | Loja de vitaminas e suplementos |
| Endereço | Asa Norte CLN 315 Lojas 03 e 04 - Asa Norte, Brasília - DF, 70774-520 |
| Quadra (regex endereço) | CLN 315 |
| Quadra (conferência por CEP) | CLN 315 |
| Par de entrequadra | 314/315 |
| Telefone | (61) 3443-8817 |
| Site | https://www.maxformsuplementos.com.br/ |
| place_id | `ChIJo-uAtIk5WpMRXzUOwkEqtMc` |
...
| Comentários | 108 | **P2** pela regra do lote (20–50 = P1 · >50 = P2 · <20 = P3) |
| Botão "Site" | presente | — |
...
1. `engine=google`, `q="MaxForm Suplementos Alimentares 315 Asa Norte" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
> Dei uma olhada no perfil de vocês no Google antes de entrar: 108 avaliações, nota 4.7.
