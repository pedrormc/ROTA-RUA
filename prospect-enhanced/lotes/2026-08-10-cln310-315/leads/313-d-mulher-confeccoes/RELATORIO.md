...
| Campo | Valor |
|---|---|
| Nome | D' Mulher Confecções |
| Nicho (categoria Google) | Loja de Roupa |
| Endereço | Bloco B - Loja 16, CLN 313 - Asa Norte, Brasília - DF, 70766-520 |
| Quadra (regex endereço) | CLN 313 |
| Quadra (conferência por CEP) | CLN 313 |
| Par de entrequadra | 312/313 |
| Telefone | (61) 3347-3660 |
| Site | http://instagram.com/dmulher |
| place_id | `ChIJU1VV5SU6WpMR75lIt5mTrbQ` |
...
1. `engine=google`, `q="D' Mulher Confecções" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
> Dei uma olhada no perfil de vocês no Google antes de entrar: 29 avaliações, nota 4.6.
