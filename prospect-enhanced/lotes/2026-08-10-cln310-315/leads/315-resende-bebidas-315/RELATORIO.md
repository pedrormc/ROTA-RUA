...
| Campo | Valor |
|---|---|
| Nome | Resende Bebidas 315 |
| Nicho (categoria Google) | Distribuidor de bebidas |
| Endereço | Asa Norte CLN 315 Lj 50 - Asa Norte, Brasília - DF, 70774-510 |
| Quadra (regex endereço) | CLN 315 |
| Quadra (conferência por CEP) | CLN 315 |
| Par de entrequadra | 314/315 |
| Telefone | (61) 98597-7980 |
| Site | — não publicado no perfil |
| place_id | `ChIJESuScAA5WpMRRrnrU33k8EU` |
...
| Comentários | 7 | **P3** pela regra do lote (20–50 = P1 · >50 = P2 · <20 = P3) |
...
1. `engine=google`, `q="Resende Bebidas 315" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
|---|---|---|
| Sem site no perfil | **Criação de Landing Page** | Quando alguém pesquisa "distribuidor de bebidas Asa Norte", este negócio não tem para onde mandar o clique. |
...
| Só 7 comentários | **Gestão Google Meu Negócio** | Volume baixo de avaliação derruba o rank local. Campanha de avaliação resolve em 60 dias. |
...
> Dei uma olhada no perfil de vocês no Google antes de entrar: 7 avaliações, nota 4.9, e reparei que não tem site no perfil.
