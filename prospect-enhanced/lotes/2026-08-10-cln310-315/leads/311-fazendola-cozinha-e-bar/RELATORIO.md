...
| Campo | Valor |
|---|---|
| Nome | Fazendola - Cozinha e Bar |
| Nicho (categoria Google) | Restaurante |
| Endereço | SHCN CLN 311, BL D - Asa Norte, Brasília - DF, 70757-540 |
| Quadra (regex endereço) | CLN 311 |
| Quadra (conferência por CEP) | CLN 311 |
| Par de entrequadra | 310/311 |
| Telefone | (61) 99204-8876 |
| Site | https://mechamenozap.com.br/fazendolacozinhaebar/ |
| place_id | `ChIJgZnA48E7WpMRcQdfpyNGwms` |
...
|---|---|---|
| Nota | 4 | Aceitável |
| Comentários | 177 | **P2** pela regra do lote (20–50 = P1 · >50 = P2 · <20 = P3) |
| Botão "Site" | presente | — |
...
1. `engine=google`, `q="Fazendola - Cozinha e Bar" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
| Nicho: Restaurante | **Gestão GMB** | Restaurante é decidido no celular a 200 m de distância. Foto e horário desatualizado matam a visita. |
...
> Dei uma olhada no perfil de vocês no Google antes de entrar: 177 avaliações, nota 4.
