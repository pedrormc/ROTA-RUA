# Borracharia do Cacau na Asa Norte
...
| Campo | Valor |
|---|---|
| Nome | Borracharia do Cacau na Asa Norte |
| Nicho (categoria Google) | Borracharia |
| Endereço | SHCN SUPER QUADRA 313 BLOCO A PLL BORRACHARIA, Asa Norte, Brasília - DF, 70766-000 |
| Quadra (regex endereço) | CLN 313 |
| Quadra (conferência por CEP) | CLN 313 |
| Par de entrequadra | 312/313 |
| Telefone | (61) 3034-3416 |
| Site | — não publicado no perfil |
| place_id | `ChIJ7UupTB87WpMRy6lcXeTA8sM` |
...
1. `engine=google`, `q="Borracharia do Cacau na Asa Norte" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
> Dei uma olhada no perfil de vocês no Google antes de entrar: 82 avaliações, nota 4.3, e reparei que não tem site no perfil.
