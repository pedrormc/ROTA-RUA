...
1. `engine=google`, `q="Posto Verde Amarelo" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
> Dei uma olhada no perfil de vocês no Google antes de entrar: 254 avaliações, nota 4.
