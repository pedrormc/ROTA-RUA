...
1. `engine=google`, `q="Gil Moreira Brasília" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
> Dei uma olhada no perfil de vocês no Google antes de entrar: 1 avaliações, nota 4, e reparei que não tem site no perfil.
