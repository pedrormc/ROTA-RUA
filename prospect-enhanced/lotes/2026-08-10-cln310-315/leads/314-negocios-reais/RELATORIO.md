...
|---|---|
| Nome | Negocios Reais |
| Nicho (categoria Google) | Consultoria de informática |
| Endereço | sala 208, CLN 314 - Plano Piloto, Brasília - DF |
| Quadra (regex endereço) | CLN 314 |
| Quadra (conferência por CEP) | CEP fora da tabela canônica |
| Par de entrequadra | 314/315 |
| Telefone | (61) 3703-0906 |
| Site | — não publicado no perfil |
| place_id | `ChIJ0y4sxok5WpMRsLdRbM6iLYM` |
...
|---|---|---|
| Nota | 4.1 | Aceitável |
| Comentários | 8 | **P3** pela regra do lote (20–50 = P1 · >50 = P2 · <20 = P3) |
...
1. `engine=google`, `q="Negocios Reais" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
|---|---|---|
| Sem site no perfil | **Criação de Landing Page** | Quando alguém pesquisa "consultoria de informática Asa Norte", este negócio não tem para onde mandar o clique. |
...
| Só 8 comentários | **Gestão Google Meu Negócio** | Volume baixo de avaliação derruba o rank local. Campanha de avaliação resolve em 60 dias. |
...
> Dei uma olhada no perfil de vocês no Google antes de entrar: 8 avaliações, nota 4.1, e reparei que não tem site no perfil.
