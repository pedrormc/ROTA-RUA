...
|---|---|
| Nome | Arena 312 |
| Nicho (categoria Google) | Bar |
| Endereço | Asa Norte CLN 312, BL A Lj 16 - Asa Norte, Brasília - DF, 70765-510 |
| Quadra (regex endereço) | CLN 312 |
| Quadra (conferência por CEP) | CLN 312 |
| Par de entrequadra | 312/313 |
| Telefone | (61) 98123-4882 |
| Site | — não publicado no perfil |
| place_id | `ChIJ9UnDqjE7WpMRds1GTXOjjUI` |
...
|---|---|---|
| Nota | 4.2 | Aceitável |
| Comentários | 9 | **P3** pela regra do lote (20–50 = P1 · >50 = P2 · <20 = P3) |
...
1. `engine=google`, `q="Arena 312" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
|---|---|---|
| Sem site no perfil | **Criação de Landing Page** | Quando alguém pesquisa "bar Asa Norte", este negócio não tem para onde mandar o clique. |
...
| Só 9 comentários | **Gestão Google Meu Negócio** | Volume baixo de avaliação derruba o rank local. Campanha de avaliação resolve em 60 dias. |
...
> Dei uma olhada no perfil de vocês no Google antes de entrar: 9 avaliações, nota 4.2, e reparei que não tem site no perfil.
