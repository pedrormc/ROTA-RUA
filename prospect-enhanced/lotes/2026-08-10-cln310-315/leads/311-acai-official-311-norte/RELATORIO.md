...
| Campo | Valor |
|---|---|
| Nome | Açaí Official 311 norte |
| Nicho (categoria Google) | Loja de açaí |
| Endereço | SHCN CLN 311 - Asa Norte, Brasília - DF, 70757-540 |
| Quadra (regex endereço) | CLN 311 |
| Quadra (conferência por CEP) | CLN 311 |
| Par de entrequadra | 310/311 |
| Telefone | (61) 98286-5753 |
| Site | https://franquias.acaiofficial.com.br/ |
| place_id | `ChIJTUrN_BQ7WpMRyDYtfFH7R88` |
...
| Comentários | 269 | **P2** pela regra do lote (20–50 = P1 · >50 = P2 · <20 = P3) |
| Botão "Site" | presente | — |
...
1. `engine=google`, `q="Açaí Official 311 norte" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
> Dei uma olhada no perfil de vocês no Google antes de entrar: 269 avaliações, nota 4.8.
