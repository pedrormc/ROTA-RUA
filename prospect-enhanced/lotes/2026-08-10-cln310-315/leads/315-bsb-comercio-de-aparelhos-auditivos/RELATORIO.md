# BSB Comércio de Aparelhos Auditivos
...
| Campo | Valor |
|---|---|
| Nome | BSB Comércio de Aparelhos Auditivos |
| Nicho (categoria Google) | Loja de aparelhos auditivos |
| Endereço | SHCN Comércio Local Norte 315 - Asa Norte, Brasília - DF, 70774-550 |
...
| place_id | `ChIJAQAwTIg5WpMRSonFO7oNhwg` |

## Google Meu Negócio

| Sinal | Valor | Leitura |
|---|---|---|
| Nota | 3 | Reputação fraca — argumento de entrada |
...
1. `engine=google`, `q="BSB Comércio de Aparelhos Auditivos" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
|---|---|---|
| Sem site no perfil | **Criação de Landing Page** | Quando alguém pesquisa "loja de aparelhos auditivos Asa Norte", este negócio não tem para onde mandar o clique. |
...
> Dei uma olhada no perfil de vocês no Google antes de entrar: 1 avaliações, nota 3, e reparei que não tem site no perfil.
