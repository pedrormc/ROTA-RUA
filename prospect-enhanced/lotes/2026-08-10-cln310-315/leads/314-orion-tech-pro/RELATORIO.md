...
| Endereço | Asa Norte CLN 314, BL B Lj 05 - Asa Norte, Brasília - DF, 70767-520 |
| Quadra (regex endereço) | CLN 314 |
| Quadra (conferência por CEP) | CLN 314 |
| Par de entrequadra | 314/315 |
| Telefone | (61) 98173-5190 |
| Site | — não publicado no perfil |
| place_id | `ChIJ1c9ghLc5WpMRzkL65OXUiyw` |
...
| Comentários | 61 | **P2** pela regra do lote (20–50 = P1 · >50 = P2 · <20 = P3) |
...
1. `engine=google`, `q="Orion Tech Pro" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
|---|---|---|
| Sem site no perfil | **Criação de Landing Page** | Quando alguém pesquisa "oficina de reparos de celulares Asa Norte", este negócio não tem para onde mandar o clique. |
...
> Dei uma olhada no perfil de vocês no Google antes de entrar: 61 avaliações, nota 4.9, e reparei que não tem site no perfil.
