...
| Campo | Valor |
|---|---|
| Nome | Borracharia Ponto Certo |
| Nicho (categoria Google) | Borracharia |
| Endereço | SHCN CLN 310, BL B QD.310 S/N - Asa Norte, Brasília - DF, 70756-520 |
| Quadra (regex endereço) | CLN 310 |
| Quadra (conferência por CEP) | CLN 310 |
| Par de entrequadra | 310/311 |
| Telefone | (61) 99355-2234 |
| Site | — não publicado no perfil |
| place_id | `ChIJRYDS_RM7WpMRtBXesuAHr0s` |
...
| Comentários | 228 | **P2** pela regra do lote (20–50 = P1 · >50 = P2 · <20 = P3) |
...
1. `engine=google`, `q="Borracharia Ponto Certo" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
|---|---|---|
| Sem site no perfil | **Criação de Landing Page** | Quando alguém pesquisa "borracharia Asa Norte", este negócio não tem para onde mandar o clique. |
...
> Dei uma olhada no perfil de vocês no Google antes de entrar: 228 avaliações, nota 4.9, e reparei que não tem site no perfil.
