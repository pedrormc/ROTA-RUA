...
| Campo | Valor |
|---|---|
| Nome | ALECRIM Produtos Naturais |
| Nicho (categoria Google) | Loja de produtos naturais |
| Endereço | Asa Norte CLN 315 LOJA 30/34 - Asa Norte, Brasília - DF, 70774-540 |
| Quadra (regex endereço) | CLN 315 |
| Quadra (conferência por CEP) | CLN 315 |
| Par de entrequadra | 314/315 |
| Telefone | (61) 99133-4607 |
| Site | https://www.instagram.com/alecrimdf/ |
| place_id | `ChIJr5UqzjA5WpMROaJsQmzxR6Q` |
...
| Comentários | 22 | **P1** pela regra do lote (20–50 = P1 · >50 = P2 · <20 = P3) |
| Botão "Site" | presente | — |
...
1. `engine=google`, `q="ALECRIM Produtos Naturais" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
> Dei uma olhada no perfil de vocês no Google antes de entrar: 22 avaliações, nota 4.5.
