...
| Campo | Valor |
|---|---|
| Nome | Stillo10 - 311 Norte |
| Nicho (categoria Google) | Loja de Roupa |
| Endereço | Asa Norte CLN 311 Lj 40 - Plano Piloto, Brasília - DF, 70757-550 |
| Quadra (regex endereço) | CLN 311 |
| Quadra (conferência por CEP) | CLN 311 |
| Par de entrequadra | 310/311 |
| Telefone | (61) 99332-4700 |
| Site | https://www.instagram.com/stillo10/ |
| place_id | `ChIJLTklDBo7WpMRr7uBidKYJTs` |
...
1. `engine=google`, `q="Stillo10 - 311 Norte" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
> Dei uma olhada no perfil de vocês no Google antes de entrar: 1 avaliações, nota 5.
