...
| Campo | Valor |
|---|---|
| Nome | Harmonia Instrumentos Musicais |
| Nicho (categoria Google) | Loja de Instrumentos Musicais |
| Endereço | Asa Norte Comércio Local Norte 310, BL B Lj 29 - Asa Norte, Brasília - DF, 70756-520 |
| Quadra (regex endereço) | CLN 310 |
| Quadra (conferência por CEP) | CLN 310 |
| Par de entrequadra | 310/311 |
| Telefone | (61) 3349-1226 |
| Site | http://www.harmoniabrasilia.com.br/ |
| place_id | `ChIJa9DLAjY6WpMRwxBc07hD6Fg` |
...
| Comentários | 210 | **P2** pela regra do lote (20–50 = P1 · >50 = P2 · <20 = P3) |
| Botão "Site" | presente | — |
...
1. `engine=google`, `q="Harmonia Instrumentos Musicais" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
> Dei uma olhada no perfil de vocês no Google antes de entrar: 210 avaliações, nota 4.5.
