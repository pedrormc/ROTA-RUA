...
| Campo | Valor |
|---|---|
| Nome | Endossa / Bsb Norte |
| Nicho (categoria Google) | Loja de acessórios de moda |
| Endereço | SCLN 310, Bloco C - Loja 14, a 20 - Asa Norte, Brasília - DF, 70756-530 |
| Quadra (regex endereço) | CLN 310 |
| Quadra (conferência por CEP) | CLN 310 |
| Par de entrequadra | 310/311 |
| Telefone | (61) 3032-4224 |
| Site | http://www.endossa.com/ |
| place_id | `ChIJq6q6kjA6WpMRk52evw1g2tA` |
...
| Comentários | 313 | **P2** pela regra do lote (20–50 = P1 · >50 = P2 · <20 = P3) |
| Botão "Site" | presente | — |
...
1. `engine=google`, `q="Endossa / Bsb Norte" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
> Dei uma olhada no perfil de vocês no Google antes de entrar: 313 avaliações, nota 4.6.
