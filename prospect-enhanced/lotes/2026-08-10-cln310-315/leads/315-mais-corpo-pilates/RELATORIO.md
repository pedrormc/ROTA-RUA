...
| Campo | Valor |
|---|---|
| Nome | Mais Corpo Pilates |
| Nicho (categoria Google) | Estúdio de pilates |
| Endereço | SHCN CLN 315 BL B Lj 11/12 - Asa Norte, Brasília - DF, 70774-520 |
| Quadra (regex endereço) | CLN 315 |
| Quadra (conferência por CEP) | CLN 315 |
| Par de entrequadra | 314/315 |
| Telefone | (61) 99157-2615 |
| Site | http://www.maispilatesstudio.com.br/ |
| place_id | `ChIJ3dJTsok5WpMRhG3qT22Tcxk` |
...
1. `engine=google`, `q="Mais Corpo Pilates" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
> Dei uma olhada no perfil de vocês no Google antes de entrar: 25 avaliações, nota 4.8.
