...
|---|---|
| Nome | Óptica M&Z |
| Nicho (categoria Google) | Ótica |
| Endereço | Asa Norte Comércio Local Norte 310, Quadra Loja 12 - Asa Norte, Brasília - DF, 70757-540 |
| Quadra (regex endereço) | CLN 310 |
| Quadra (conferência por CEP) | CLN 311 |
| Par de entrequadra | 310/311 |
| Telefone | (61) 99523-2922 |
| Site | — não publicado no perfil |
| place_id | `ChIJZXQBRkQ7WpMRhy09HW5uPnE` |
...
| Comentários | 15 | **P3** pela regra do lote (20–50 = P1 · >50 = P2 · <20 = P3) |
...
1. `engine=google`, `q="Óptica M&Z" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
|---|---|---|
| Sem site no perfil | **Criação de Landing Page** | Quando alguém pesquisa "ótica Asa Norte", este negócio não tem para onde mandar o clique. |
...
| Só 15 comentários | **Gestão Google Meu Negócio** | Volume baixo de avaliação derruba o rank local. Campanha de avaliação resolve em 60 dias. |
...
> Dei uma olhada no perfil de vocês no Google antes de entrar: 15 avaliações, nota 5, e reparei que não tem site no perfil.
