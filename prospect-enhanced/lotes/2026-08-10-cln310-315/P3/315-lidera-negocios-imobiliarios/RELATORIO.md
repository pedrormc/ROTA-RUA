...
| Campo | Valor |
|---|---|
| Nome | Lidera Negócios Imobiliários |
| Nicho (categoria Google) | Imobiliária |
...
| Telefone | (61) 3033-5252 |
| Site | — não publicado no perfil |
| place_id | `ChIJAQAwTIg5WpMRuG_WyPubjQ8` |
...
1. `engine=google`, `q="Lidera Negócios Imobiliários" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
|---|---|---|
| Sem site no perfil | **Criação de Landing Page** | Quando alguém pesquisa "imobiliária Asa Norte", este negócio não tem para onde mandar o clique. |
