...
1. `engine=google`, `q="Karisma Moda Feminina" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
> Dei uma olhada no perfil de vocês no Google antes de entrar: 3 avaliações, nota 5, e reparei que não tem site no perfil.
