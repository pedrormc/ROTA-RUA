...
| Campo | Valor |
|---|---|
| Nome | Brechó Zoe Brasil |
| Nicho (categoria Google) | Brechó |
| Endereço | CLN 314 bloco D loja 61 Galeria/subsolo, SHCN, Brasília - DF, 70767-540 |
...
| place_id | `ChIJNUvbx1M6WpMRkxbiId142N8` |
...
1. `engine=google`, `q="Brechó Zoe Brasil" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
|---|---|---|
| Sem site no perfil | **Criação de Landing Page** | Quando alguém pesquisa "brechó Asa Norte", este negócio não tem para onde mandar o clique. |
...
> Dei uma olhada no perfil de vocês no Google antes de entrar: 17 avaliações, nota 4.2, e reparei que não tem site no perfil.
