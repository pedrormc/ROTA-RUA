...
| Campo | Valor |
|---|---|
| Nome | Relojoeiro - Subsolo |
| Nicho (categoria Google) | Relojoaria |
| Endereço | SHCN CLN 312 - Plano Piloto, Brasília - DF, 70765-500 |
...
| place_id | `ChIJb5JCfgA7WpMREuu6vflAkzk` |
...
1. `engine=google`, `q="Relojoeiro - Subsolo" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
|---|---|---|
| Sem site no perfil | **Criação de Landing Page** | Quando alguém pesquisa "relojoaria Asa Norte", este negócio não tem para onde mandar o clique. |
...
> Dei uma olhada no perfil de vocês no Google antes de entrar: 19 avaliações, nota 3.9, e reparei que não tem site no perfil.
