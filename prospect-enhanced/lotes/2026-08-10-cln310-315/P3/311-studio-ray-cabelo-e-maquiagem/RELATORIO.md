...
| Campo | Valor |
|---|---|
| Nome | STUDIO RAY | Cabelo e Maquiagem |
| Nicho (categoria Google) | Salão de Beleza |
| Endereço | Asa Norte CLN 311, BL D Lj 32 - Asa Norte, Brasília - DF, 70757-540 |
| Quadra (regex endereço) | CLN 311 |
| Quadra (conferência por CEP) | CLN 311 |
| Par de entrequadra | 310/311 |
| Telefone | (61) 99314-1305 |
| Site | — não publicado no perfil |
| place_id | `ChIJlZsELHo7WpMRotIFNmThIXg` |
...
1. `engine=google`, `q="STUDIO RAY | Cabelo e Maquiagem" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
> Dei uma olhada no perfil de vocês no Google antes de entrar: 2 avaliações, nota 4.5, e reparei que não tem site no perfil.
