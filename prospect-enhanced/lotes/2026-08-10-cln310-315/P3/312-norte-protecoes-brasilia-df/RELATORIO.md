# NORTE PROTEÇÕES Brasília DF

**CLN 312 Norte** (par 312/313) · Prioridade **P3** · Lote `2026-08-10-cln310-315`

> Dados coletados do Google Maps via SerpAPI em 2026-08-10. Evidência crua: `../../raw/q312-s20.json`.

## Identificação

| Campo | Valor |
|---|---|
| Nome | NORTE PROTEÇÕES Brasília DF |
| Nicho (categoria Google) | Serviço de segurança |
| Endereço | Asa Norte CLN 312, BL A - Asa Norte, Brasília - DF, 70070-600 |
| Quadra (regex endereço) | CLN 312 |
| Quadra (conferência por CEP) | CEP fora da tabela canônica |
| Par de entrequadra | 312/313 |
| Telefone | (61) 98377-6513 |
| Site | https://www.catalogo-digital.com/norteprotecoes |
| place_id | `ChIJ4TKgNYA7WpMRjs7Wdm1EZbU` |

## Google Meu Negócio

| Sinal | Valor | Leitura |
|---|---|---|
| Nota | — | Reputação fraca — argumento de entrada |
| Comentários | 0 | **P3** pela regra do lote (20–50 = P1 · >50 = P2 · <20 = P3) |
| Botão "Site" | presente | — |
...
1. `engine=google`, `q="NORTE PROTEÇÕES Brasília DF" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
| Só 0 comentários | **Gestão Google Meu Negócio** | Volume baixo de avaliação derruba o rank local. Campanha de avaliação resolve em 60 dias. |
...
> Dei uma olhada no perfil de vocês no Google antes de entrar: 0 avaliações.
