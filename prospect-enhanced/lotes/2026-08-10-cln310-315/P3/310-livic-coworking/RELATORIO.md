...
| Campo | Valor |
|---|---|
| Nome | Livic Coworking |
| Nicho (categoria Google) | Espaço de coworking |
| Endereço | Asa Norte CLN 310 Sl 216 - Plano Piloto, Brasília - DF, 70756-530 |
| Quadra (regex endereço) | CLN 310 |
| Quadra (conferência por CEP) | CLN 310 |
| Par de entrequadra | 310/311 |
| Telefone | (61) 99916-2462 |
| Site | http://www.livic.com.br/ |
| place_id | `ChIJWfmWqWw7WpMRYhUjkc2-PG0` |
...
1. `engine=google`, `q="Livic Coworking" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
> Dei uma olhada no perfil de vocês no Google antes de entrar: 13 avaliações, nota 4.9.
