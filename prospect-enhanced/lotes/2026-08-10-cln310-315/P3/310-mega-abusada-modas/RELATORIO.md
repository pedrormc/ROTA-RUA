...
| Campo | Valor |
|---|---|
| Nome | Mega Abusada Modas |
| Nicho (categoria Google) | Loja de moda feminina |
| Endereço | SHCN CLN 310 Sl 205 - Asa Norte, Brasília - DF, 70756-520 |
| Quadra (regex endereço) | CLN 310 |
| Quadra (conferência por CEP) | CLN 310 |
| Par de entrequadra | 310/311 |
| Telefone | (61) 99353-4659 |
| Site | http://www.megaabusada.com.br/ |
| place_id | `ChIJ2UYGErc7WpMRP9ACLfbMTSs` |
...
1. `engine=google`, `q="Mega Abusada Modas" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
> Dei uma olhada no perfil de vocês no Google antes de entrar: 13 avaliações, nota 5.
