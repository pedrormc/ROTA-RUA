...
| Endereço | Asa Norte Comércio Local Norte 310 Bl D Loja 37 - Asa Norte, Brasília - DF, 70756-540 |
| Quadra (regex endereço) | CLN 310 |
| Quadra (conferência por CEP) | CLN 310 |
| Par de entrequadra | 310/311 |
| Telefone | (61) 99921-9841 |
| Site | https://www.modacoreflor.com.br/ |
| place_id | `ChIJU624LFA7WpMRtHW-8n61XxQ` |
...
1. `engine=google`, `q="Cor & Flor" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
> Dei uma olhada no perfil de vocês no Google antes de entrar: 6 avaliações, nota 4.5.
