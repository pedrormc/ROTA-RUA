...
| Campo | Valor |
|---|---|
| Nome | Lavanderia D Lav |
| Nicho (categoria Google) | Lavanderia |
| Endereço | SHCN Comércio Local Norte 312 - Plano Piloto, Brasília - DF, 70765-550 |
| Quadra (regex endereço) | CLN 312 |
| Quadra (conferência por CEP) | CLN 312 |
| Par de entrequadra | 312/313 |
| Telefone | (61) 3347-7063 |
| Site | — não publicado no perfil |
| place_id | `ChIJb88vwSU6WpMRPRSfYElzp2w` |
...
1. `engine=google`, `q="Lavanderia D Lav" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
> Dei uma olhada no perfil de vocês no Google antes de entrar: 9 avaliações, nota 4, e reparei que não tem site no perfil.
