...
| Campo | Valor |
|---|---|
| Nome | SPA Ágata Amaral - Asa Norte |
| Nicho (categoria Google) | Spa |
| Endereço | Asa Norte CLN 310, Bloco B Lj 5 - Asa Norte, Brasília - DF, 70756-520 |
| Quadra (regex endereço) | CLN 310 |
| Quadra (conferência por CEP) | CLN 310 |
| Par de entrequadra | 310/311 |
| Telefone | (61) 99173-7452 |
| Site | https://www.agataamaralspa.com.br/ |
| place_id | `ChIJC4cTpnc7WpMRa_SKvKhL6Ek` |
...
| Comentários | 10 | **P3** pela regra do lote (20–50 = P1 · >50 = P2 · <20 = P3) |
| Botão "Site" | presente | — |
...
1. `engine=google`, `q="SPA Ágata Amaral - Asa Norte" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
| Só 10 comentários | **Gestão Google Meu Negócio** | Volume baixo de avaliação derruba o rank local. Campanha de avaliação resolve em 60 dias. |
...
> Dei uma olhada no perfil de vocês no Google antes de entrar: 10 avaliações, nota 5.
