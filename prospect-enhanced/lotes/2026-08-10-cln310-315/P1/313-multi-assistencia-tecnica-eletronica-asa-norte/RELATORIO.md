# Multi Assistência Técnica Eletrônica - Asa Norte
...
| Campo | Valor |
|---|---|
| Nome | Multi Assistência Técnica Eletrônica - Asa Norte |
...
| Comentários | 35 | **P1** pela regra do lote (20–50 = P1 · >50 = P2 · <20 = P3) |
| Botão "Site" | presente | — |
...
1. `engine=google`, `q="Multi Assistência Técnica Eletrônica - Asa Norte" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
> Dei uma olhada no perfil de vocês no Google antes de entrar: 35 avaliações, nota 4.8.
