...
| Campo | Valor |
|---|---|
| Nome | Lígia Dantas Salão e Estética |
| Nicho (categoria Google) | Salão de Beleza |
| Endereço | Asa Norte Comércio Local Norte 312, BL E 312 Lj 61 - Asa Norte, Brasília - DF, 70765-550 |
| Quadra (regex endereço) | CLN 312 |
| Quadra (conferência por CEP) | CLN 312 |
| Par de entrequadra | 312/313 |
| Telefone | (61) 3349-3321 |
| Site | — não publicado no perfil |
| place_id | `ChIJZ4umQfE7WpMRjsBNgh_nDJg` |
...
| Comentários | 25 | **P1** pela regra do lote (20–50 = P1 · >50 = P2 · <20 = P3) |
...
1. `engine=google`, `q="Lígia Dantas Salão e Estética" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
> Dei uma olhada no perfil de vocês no Google antes de entrar: 25 avaliações, nota 4.8, e reparei que não tem site no perfil.
