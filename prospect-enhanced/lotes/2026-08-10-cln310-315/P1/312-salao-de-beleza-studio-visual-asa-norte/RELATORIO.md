# Salão de Beleza Studio Visual - Asa Norte
...
| Campo | Valor |
|---|---|
| Nome | Salão de Beleza Studio Visual - Asa Norte |
| Nicho (categoria Google) | Salão de Beleza |
| Endereço | SHCN SQN 312 - Asa Norte, Brasília - DF, 70765-540 |
| Quadra (regex endereço) | CLN 312 |
| Quadra (conferência por CEP) | CLN 312 |
| Par de entrequadra | 312/313 |
| Telefone | (61) 98153-0260 |
| Site | https://www.instagram.com/studiovisualbsb |
| place_id | `ChIJH4ntIwM7WpMRdBk6hIXaoV8` |
...
| Comentários | 21 | **P1** pela regra do lote (20–50 = P1 · >50 = P2 · <20 = P3) |
| Botão "Site" | presente | — |
...
1. `engine=google`, `q="Salão de Beleza Studio Visual - Asa Norte" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
> Dei uma olhada no perfil de vocês no Google antes de entrar: 21 avaliações, nota 4.9.
