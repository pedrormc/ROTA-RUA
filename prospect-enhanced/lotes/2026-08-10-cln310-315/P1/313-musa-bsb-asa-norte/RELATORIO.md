...
| Campo | Valor |
|---|---|
| Nome | Musa Bsb - Asa Norte |
| Nicho (categoria Google) | Loja de Roupa |
| Endereço | Asa Norte Comércio Local Norte 313 - Asa Norte, Brasília - DF, 70766-540 |
| Quadra (regex endereço) | CLN 313 |
| Quadra (conferência por CEP) | CLN 313 |
| Par de entrequadra | 312/313 |
| Telefone | (61) 3447-7000 |
| Site | — não publicado no perfil |
| place_id | `ChIJ9cSIwiU6WpMRI1bW5z0SUaY` |
...
1. `engine=google`, `q="Musa Bsb - Asa Norte" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
> Dei uma olhada no perfil de vocês no Google antes de entrar: 25 avaliações, nota 4.9, e reparei que não tem site no perfil.
