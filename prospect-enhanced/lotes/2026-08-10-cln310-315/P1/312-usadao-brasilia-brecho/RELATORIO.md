# Usadão Brasília Brechó

**CLN 312 Norte** (par 312/313) · Prioridade **P1** · Lote `2026-08-10-cln310-315`
...
| Campo | Valor |
|---|---|
| Nome | Usadão Brasília Brechó |
| Nicho (categoria Google) | Brechó |
| Endereço | Asa Norte CLN 312 Lj 23 - Asa Norte, Brasília - DF, 70765-530 |
| Quadra (regex endereço) | CLN 312 |
| Quadra (conferência por CEP) | CLN 312 |
| Par de entrequadra | 312/313 |
| Telefone | (61) 98582-8638 |
| Site | — não publicado no perfil |
| place_id | `ChIJAQAw7CU6WpMRFvjOUq6tXgw` |
...
| Comentários | 48 | **P1** pela regra do lote (20–50 = P1 · >50 = P2 · <20 = P3) |
...
1. `engine=google`, `q="Usadão Brasília Brechó" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
> Dei uma olhada no perfil de vocês no Google antes de entrar: 48 avaliações, nota 4.5, e reparei que não tem site no perfil.
