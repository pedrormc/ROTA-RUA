# EVS 315 Norte :: Herbalife

**CLN 315 Norte** (par 314/315) · Prioridade **P1** · Lote `2026-08-10-cln310-315`
...
| Campo | Valor |
|---|---|
| Nome | EVS 315 Norte :: Herbalife |
| Nicho (categoria Google) | Restaurante de comida natural |
| Endereço | Asa Norte Comércio Local Norte 315 Sl 102 - Asa Norte, Brasília - DF, 70774-550 |
| Quadra (regex endereço) | CLN 315 |
| Quadra (conferência por CEP) | CLN 315 |
| Par de entrequadra | 314/315 |
| Telefone | (61) 98222-6851 |
| Site | http://www.facebook.com/franvilmavidal |
| place_id | `ChIJMQwDTIg5WpMRP5BBd98889U` |

## Google Meu Negócio

| Sinal | Valor | Leitura |
|---|---|---|
| Nota | 4.8 | Boa reputação |
| Comentários | 43 | **P1** pela regra do lote (20–50 = P1 · >50 = P2 · <20 = P3) |
| Botão "Site" | presente | — |
...
1. `engine=google`, `q="EVS 315 Norte :: Herbalife" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
> **Conferir manualmente:** Marca Herbalife, mas operação local independente
...
> Dei uma olhada no perfil de vocês no Google antes de entrar: 43 avaliações, nota 4.8.
