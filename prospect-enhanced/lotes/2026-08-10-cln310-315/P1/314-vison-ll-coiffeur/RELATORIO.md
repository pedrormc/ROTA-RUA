...
1. `engine=google`, `q="Vison ll Coiffeur" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
> Dei uma olhada no perfil de vocês no Google antes de entrar: 25 avaliações, nota 4.4, e reparei que não tem site no perfil.
