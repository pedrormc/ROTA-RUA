# Studio Elaine Express

**CLN 314 Norte** (par 314/315) · Prioridade **P1** · Lote `2026-08-10-cln310-315`
...
1. `engine=google`, `q="Studio Elaine Express" CNPJ Brasilia` → extrair candidatos com regex de CNPJ.
...
> Dei uma olhada no perfil de vocês no Google antes de entrar: 39 avaliações, nota 4.1, e reparei que não tem site no perfil.
